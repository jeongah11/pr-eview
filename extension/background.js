...
const PROMPTS = {
  ...
  // 질문 도우미: 리뷰 질문 초안
  question:
    "당신은 10년 경력의 시니어 개발자입니다. 아래 코드 변경을 보고 작성자에게 던질 리뷰 질문 1개를 " +
  ...
  prBody:
    ...
    "한국어 마크다운으로 쓰세요. 다음 형식을 지키세요: " +
    "'## 목적', '## 주요 변경점', '## 코드 설명 (어떻게 동작하나)', " +
    "'## 용어 설명'(어려운 개발 용어·API·패턴이 있으면 한 줄로 풀이), " +
    "'## 리뷰 포인트 / 고민한 점'. " +
    "하나의 PR에는 하나의 목적만 담는 것이 좋으니, 여러 기능이 섞여 보이면 그 점도 짚어주세요.",
};
